...
final class Version20190417092229 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD username VARCHAR(180) NOT NULL, ADD roles JSON NOT NULL, ADD password VARCHAR(255) NOT NULL, DROP email, DROP pwd, DROP level, DROP amount');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD pwd VARCHAR(255) NOT NULL COLLATE latin1_swedish_ci, ADD level INT NOT NULL, ADD amount INT NOT NULL, DROP username, DROP roles, CHANGE password email VARCHAR(255) NOT NULL COLLATE latin1_swedish_ci');
    }
}
